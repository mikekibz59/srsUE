...
//  pdcp.init(&rlc, &rrc, &gw, &pdcp_log);
  ...
  dummy_rrc_args_t dummy_rrc_args;
  dummy_rrc_args.snkport = 9998;
  dummy_rrc_args.srcport = 9999;
  dummy_rrc.init(&dummy_rrc_args, &nas, &rrc_log);
  nas.init(&usim, &dummy_rrc, &dummy_gw, &nas_log);
